...
/* *** MODIFIED VERSION OF https://github.com/bryik/aframe-cubemap-component */
...
AFRAME.registerComponent("cubemap", {
  ...
  update: function (oldData) {
    ...
    if (data.color !== oldData.color) {
      ...
      this.material.uniforms['color'].value = [color.r, color.g, color.b, 1.0];
    }
