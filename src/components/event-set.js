// modified version of https://github.com/supermedium/superframe/tree/master/components/event-set/
  ...
  updateEventListener: function () {
    ...
    const handler = () => {
      ...
      for (propName in data) {
        ...
        if (value === 'TOGGLE') {
          value = !AFRAME.utils.entity.getComponentProperty(targetEl, propName);
        }
        AFRAME.utils.entity.setComponentProperty.call(this, targetEl, propName, value);
      }
    };
